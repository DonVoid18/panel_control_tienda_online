    ...
    <main>
        <section class="main-container">
            ...
            <div class="page-content">
                ...
                <div class="content">
                    <div class="">
                        <h4 class="page-title">Tabla de Comentarios</h4>
                                ...
                                <div class="cs-field select">
                                    ...
                                    <div class="select-contianer">
                                        <select name="" id="">
                                            ...
                                            <option value="">Mayor Puntaje</option>
                                            <option value="">Menor Puntaje</option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="company-name">
                                                ...
                                                <p>'.$row['fecha_registro'].'
                                            </div>
                                        </td>
                                        <td>'.$row['productos_id_producto'].'</td>
                                        <td>'.$row['usuarios_id_usuario'].'</td>
                                        <td>'.$row['comentario'].'</td>
                                        <td>'.$row['producto_puntaje'].'</td>
                                        <td>
